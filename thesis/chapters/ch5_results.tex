...
is thereby downgraded to a question for the full five-year run, with the Volmageddon and COVID
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=1.0\textwidth]{figures/nb04_c09_2.png}
    }
...
subsampling. Only the real-only and finetuned regimes are shown. The zero-shot synthetic-only
DeepONet is omitted because it passes the fit gate on $2$ days out of $386$, and the invariance
