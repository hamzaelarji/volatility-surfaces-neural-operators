...
\caption{Constraint-specific collocation on the maturity axis $[0.06,1.4]$. The literature's
...
scale}: an earlier, magnitude-inconsistent detector false-alarmed on residuals four orders of
magnitude below materiality (Section~\ref{sec:deep}), which the material-scale comparison
eliminates.
